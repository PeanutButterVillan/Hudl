...
public class Intermediary {
    ...
    public String toString() {
        return "ClassPojo [firstName = "+firstName+", password = "+password+", contactNumber = "+contactNumber+", recoveryPassword = "+recoveryPassword+", emailConfirmationCode = "+emailConfirmationCode+", fullName = "+fullName+", contactSupportId = "+contactSupportId+", emailId = "+emailId+", govGatewayIdentityNumber = "+govGatewayIdentityNumber+", secondName = "+secondName+"]";
    }
}
